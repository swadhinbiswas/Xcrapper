...
class TextStyle:
    ...
    def welcome(self):
        ...
        # Option 1: Login
        option_1_text = Text("[1] Login to Twitter\n", style="bold green")
        

        # Option 2: Continue without logging in
        option_2_text = Text("[2] Continue without logging in\n", style="bold blue",justify= "right")
        
        text=Text.assemble(welcome_text, instruction_text, option_1_text, option_2_text)
